...
| 2.1.2 | Create Postgres adapter for `PersistencePort` | Adapter: question/answer/vote persistence to Postgres; same schema; all M1 aggregates round-trip | 2.1.1 | cc:done [25a47e3] |
