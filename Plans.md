...
| 1.2.3 | Implement `authority_weight()` as pure function of (scope, freshness) | Pure function computed from scope and expiry; no hidden state; deterministic on same inputs | 1.2.2 | cc:WIP |
